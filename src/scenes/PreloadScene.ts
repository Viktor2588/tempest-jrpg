...
import borderTravelerPortraitUrl from '../assets/sprites/portrait-border-traveler.webp';
...
import bossEmblemUrl from '../assets/ui/boss-emblem.webp';
...
export class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image(portraitKey('border-traveler'), borderTravelerPortraitUrl);
    ...
    this.load.image(BATTLE_ARENA_TEXTURES['tempest-camp'], tempestCampBattleUrl);
    this.load.image(BATTLE_ARENA_TEXTURES['tempest-village'], tempestVillageBattleUrl);
    this.load.image(BATTLE_ARENA_TEXTURES['tempest-city'], tempestCityBattleUrl);
    ...
    this.load.image('ui-boss-emblem', bossEmblemUrl);
  }
