...
export const ENEMIES = [
  ...
  { id: 'masked-majin', name: 'Maskierter Majin', level: 12, boss: true, element: 'shadow', stats: { maxHp: 560, maxMp: 48, attack: 52, defense: 18, magic: 82, spirit: 22, agility: 26 }, skillIds: ['black-flame', 'spirit-bind', 'umbral-burst'], phase2SkillIds: ['calamity-roar', 'temporal-snare'], devourable: true, devourSkillId: 'black-flame', weaknesses: ['holy'], resistances: ['shadow'], experienceReward: 320, goldReward: 120, drops: [{ itemId: 'magic-ore', chance: 0.25 }] },
