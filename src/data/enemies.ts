...
export const ENEMIES = [
  ...
  { id: 'magic-colossus', name: 'Magiekoloss', level: 18, boss: true, element: 'earth', stats: { maxHp: 780, maxMp: 80, attack: 82, defense: 38, magic: 54, spirit: 34, agility: 16 }, skillIds: ['ogre-smash', 'iron-guard', 'spirit-bind'], phase2SkillIds: ['temporal-snare', 'black-flame', 'petrifying-gaze'], escalationPercentPerTurn: 10, armoredUntilBreak: true, devourable: true, devourSkillId: 'iron-guard', summonEnemyId: 'stray-echo', summonCount: 2, weaknesses: ['wind', 'water'], resistances: ['neutral'], nullifies: ['earth'], experienceReward: 760, goldReward: 220, drops: [{ itemId: 'magisteel', chance: 1 }, { itemId: 'spirit-ember', chance: 0.6 }] },
