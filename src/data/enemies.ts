...
export const ENEMIES = [
  ...
  { id: 'thorn-treant', name: 'Dornen-Treant', level: 7, element: 'earth', stats: { maxHp: 168, maxMp: 18, attack: 38, defense: 24, magic: 18, spirit: 18, agility: 8 }, skillIds: ['ogre-smash', 'iron-guard'], armoredUntilBreak: true, devourable: true, devourSkillId: 'iron-guard', weaknesses: ['fire', 'wind'], resistances: ['earth'], experienceReward: 210, goldReward: 35, drops: [{ itemId: 'healing-herb', chance: 0.35 }] },
  { id: 'marsh-hexer', name: 'Moor-Molchhexer', level: 6, element: 'shadow', stats: { maxHp: 104, maxMp: 38, attack: 18, defense: 14, magic: 32, spirit: 24, agility: 15 }, skillIds: ['venom-spit', 'spirit-bind', 'soothing-prayer'], healsAllies: true, devourable: true, devourSkillId: 'spirit-bind', weaknesses: ['holy', 'wind'], resistances: ['shadow', 'water'], experienceReward: 230, goldReward: 46, drops: [{ itemId: 'mana-drop', chance: 0.35 }] },
  { id: 'storm-shard', name: 'Sturmscherbengeist', level: 12, element: 'wind', stats: { maxHp: 144, maxMp: 52, attack: 24, defense: 19, magic: 48, spirit: 30, agility: 26 }, skillIds: ['storm-gust', 'temporal-snare'], resistsCategory: 'magical', devourable: true, devourSkillId: 'storm-gust', weaknesses: ['earth'], resistances: ['wind'], experienceReward: 350, goldReward: 70, drops: [{ itemId: 'magic-ore', chance: 0.3 }] },
