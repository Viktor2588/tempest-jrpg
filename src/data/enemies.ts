...
export const ENEMIES = [
  ...
  { id: 'orc-soldier', name: 'Ork-Soldat', level: 7, element: 'earth', stats: { maxHp: 140, maxMp: 10, attack: 42, defense: 15, magic: 6, spirit: 8, agility: 9 }, skillIds: ['orc-cleave', 'war-cry'], devourable: true, devourSkillId: 'orc-cleave', weaknesses: ['fire', 'holy'], resistances: [], experienceReward: 260, goldReward: 20, drops: [{ itemId: 'magic-ore', chance: 0.25 }, { itemId: 'orc-tusk', chance: 0.35 }] },
  ...
  { id: 'gabiru', name: 'Gabiru', level: 11, boss: true, element: 'wind', stats: { maxHp: 450, maxMp: 28, attack: 104, defense: 18, magic: 64, spirit: 14, agility: 30 }, skillIds: ['spear-charge', 'storm-gust', 'tide-lance'], phase2SkillIds: ['calamity-roar', 'iron-guard'], escalationPercentPerTurn: 12, devourable: true, devourSkillId: 'spear-charge', weaknesses: ['shadow'], resistances: ['wind', 'water'], experienceReward: 420, goldReward: 70, drops: [{ itemId: 'wolf-fang-token', chance: 0.5 }] },
