...
export const ENEMIES = [
  ...
  { id: 'milim', name: 'Milim Nava', level: 20, boss: true, element: 'fire', stats: { maxHp: 999, maxMp: 200, attack: 60, defense: 50, magic: 70, spirit: 50, agility: 60 }, skillIds: ['drago-nova', 'ogre-smash', 'black-flame'], phase2SkillIds: ['pyre-field', 'calamity-roar', 'temporal-snare'], escalationPercentPerTurn: 12, devourable: false, weaknesses: ['holy'], resistances: ['fire', 'earth', 'shadow', 'neutral'], experienceReward: 1000, goldReward: 300, drops: [{ itemId: 'magisteel', chance: 1 }, { itemId: 'full-potion', chance: 1 }] },
