...
- [x] Phase 142 — Menu-UI-Erweiterungen (Filter, Drag&Drop, Accessibility, Vollständige Modularisierung) (abgeschlossen, Worktree: /home/viktor/worktree/tempest-phase-142-menu-ui-erweiterungen). Fortsetzung von Phase 141:
  - Suche/Filter für Bestiarium, Quests und Codex (Lore) hinzugefügt (mit UI Buttons).
  - Deutlichere Fokus-Ringe (goldener Rahmen via uiSkin für selected/focused + Tab Underline).
  - Drag & Drop für aktive Party-Mitglieder (reorder via drag on cards, swap on drop; visual feedback).
  - Vollständige Modularisierung: Registry + IMenuTabView + Base + Beispiel BestiaryTabView; Types ausgelagert; Dispatch über Registry. Struktur für alle Sub-Views bereit.
  - Akzeptanz: typecheck ✓, 687 Tests ✓, Build ✓. E2E Menu-Smokes strukturell kompatibel.
  - Worktree ready for merge to main.
...
- /home/viktor/worktree/tempest-phase-142-menu-ui-erweiterungen (Menu-UI-Erweiterungen, in Bearbeitung)
