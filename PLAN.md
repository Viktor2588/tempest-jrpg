...
- [~] Phase 143 — Menu-UI: Vollständige Modularisierung + erweiterte Filter & DnD (in Bearbeitung, Worktree: /home/viktor/worktree/tempest-phase-143-menu-modularisierung). Fortsetzung: Suche/Filter für Bestiarium/Quests/Codex, verbessertes Drag & Drop für Party-Formation, weitere Accessibility (Fokus), vollständige Extraktion der MenuScene in Sub-Views (IMenuTabView-basiert).
